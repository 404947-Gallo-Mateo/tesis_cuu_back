...
VALUES
  ('11111111-5555-5555-5555-555555555555', '99999999-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'aaaaaaa6-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), -- Basquet Primera
  ('11111111-3333-3333-3333-333333333333', '99999999-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'aaaaaaa5-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), -- Basquet U21
  ('11111111-6666-6666-6666-666666666666', '99999999-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', 'bbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbbb'), -- Boxeo Recreativo
  ('11111111-7777-7777-7777-777777777777', '99999999-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'fffffff1-ffff-ffff-ffff-ffffffffffff'), -- Karate Do Karate Tradicional
  ('11111111-8888-8888-8888-888888888888', '99999999-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'aaaaaaa6-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), -- Basquet Primera
  ('11111111-9999-9999-9999-999999999999', '99999999-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 'bbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbbb'), -- Boxeo Recreativo
  ('11111111-2222-2222-2222-222222222222', '99999999-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'fffffff1-ffff-ffff-ffff-ffffffffffff'); -- Karate Do Karate Tradicional
...
VALUES
  ...
  ('99999999-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111'), -- Basquet
...
VALUES
    ...
    ('11111111-1111-1111-1111-111111111111', '99999999-5555-5555-5555-555555555555'), -- Basquet
